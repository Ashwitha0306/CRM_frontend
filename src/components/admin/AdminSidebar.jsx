...
const navItems = [
  ...
  { to: '/admin/dashboard/attendance', label: 'Attendance', icon: <FiCalendar /> },
  { to: '/admin/dashboard/leaves', label: 'Leaves', icon: <FiFileText /> },
  { to: '/admin/dashboard/tasks', label: 'Tasks', icon: <FiList /> },
  { to: '/admin/dashboard/roles', label: 'Roles', icon: <FiShield /> },
  { to: '/admin/dashboard/logs', label: 'Activity Logs', icon: <FiActivity /> },
  { to: '/admin/dashboard/files', label: 'Files', icon: <FiFolder /> },
          ...
          >
            ...
            >
              <div className="p-6">
                ...
                >
                  You're about to sign out of your admin session. Are you sure?
                </motion.p>
                <div className="flex justify-end gap-4">
                  ...
                  <motion.button
                    ...
                    className="px-5 py-2.5 rounded-lg bg-red-500 text-white hover:bg-red-600 flex items-center shadow-md transition-colors"
                  >
      ...
      >
        ...
        <div className="p-3 space-y-2">
          ...
          <motion.div
            ...
            text-red-500 dark:text-red-400 relative overflow-hidden`}
